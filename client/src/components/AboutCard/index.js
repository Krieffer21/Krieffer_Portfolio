    ...
    return (
        <div>
            <div className="bg-img row justify-content-md-center">
                <div className="col-md-6 col-sm-12 col-lg-10 mx-auto">
                    <div id="about" className="row">
                        ...
                        <p className="meText mt-1 mb-1 col"> I am an artist and aspiring web developer, with a creative eye for uniqueness. I am a wonderful team player full of ideas. As someone who is familiar with the art world I am excited to now have a hand in the coding world.
